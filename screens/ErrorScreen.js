...
const ErrorScreen = ({navigation}) => {
  return (
    <View style={styles.successScreenContainer}>
        <Text style={styles.messageTextStyle}>Oops! Looks like</Text>
        <Text style={styles.messageTextStyle}>User has already</Text>
        <Text style={styles.messageTextStyle}>redeemed the coupon</Text> 
